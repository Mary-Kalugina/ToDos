import * as template from 'wml!IntegrationButtons/Connectors/AmoCrm/Settings';
...
export default class Settings extends Control<IControlOptions> {
    ...
    protected _additionalSettings: string;
     ...
     * @protected
     */
    protected beforeSaveCard(): Promise<boolean> {
    ...
    haveBeenSettingsChanged(): Promise<boolean> {
